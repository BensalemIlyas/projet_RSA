...
void analyse_commandes(char *commande_cut, int tab_cmd[NB_CMD]) {
    ...
    else if(strcmp(commande_cut,"modifycontact")==0) tab_cmd[CMD_MC]=1;
    else if(strcmp(commande_cut,"addkeys")==0) tab_cmd[CMD_AK]=1;
    else if(strcmp(commande_cut,"rmcontact")==0) tab_cmd[CMD_RC]=1;
}
...
void execution_commande(int tab_cmd[NB_CMD], utilisateur_t* user, char* param1, char* param2, char* param3) {
    if(tab_cmd[CMD_M]==1) {
        ...
        if(erreur_listcontacts(user,param1,param2,param3)==1) {
            listcontacts(user,param1,param2);
        }
    }

    else if(tab_cmd[CMD_AC]==1) {
        if(erreur_addcontact(user,param1,param2,param3)==1) {
            addcontact(user,param1);
        }
    }

    else if(tab_cmd[CMD_MC]==1) {
        if(erreur_modifycontact(user,param1,param2,param3)==1) {
            modifycontact(user,param1);
        }
    }

    else if(tab_cmd[CMD_AK]==1) {
        if(erreur_addkeys(user,param1,param2,param3)==1) {
            addkeys(user,param1);
        }
    }

    else if(tab_cmd[CMD_RC]==1) {
        printf("gestion erreur+exécution commande pour rmcontact à faire\n");
        if(erreur_rmcontact(user,param1,param2,param3)==1) {
            rmcontact(user,param1);
        }
    }
}
