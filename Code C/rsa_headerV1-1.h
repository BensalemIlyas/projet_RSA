...
#define NB_CMD 20 //nombre de commandes possibles pour l'instant (v1.1)
#define CMD_M 0 //man
...
typedef struct contact_s {
		char nameContact[NAME_MAX_SIZE];
		int idContact;
		int nbId;
		identificateur_t *identificateurs;
} contact_t;
...
typedef struct utilisateur_s {
    ...
    identificateur_t *tabId;    //pour avoir un tab d'identificateur
		contact_t *contacts;    //pour avoir un tab d'identificateur
} utilisateur_t;
////////////////////////////////////////////////////////////////////////
